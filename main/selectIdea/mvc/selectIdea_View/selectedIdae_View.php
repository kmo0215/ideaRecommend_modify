...
<meta property="og:title" content="메타타이틀값OG"/>
<meta property="og:type" content="article"/>
<meta property="og:url" content="http://localhost/ideaRecommend/MVC/main/selectIdea/mvc/selectIdea_View/selectedIdae_View.php?id='<?=$_GET['id']?>'"/>
<meta property="og:image" content="https://ssl.pstatic.net/mimgnews/image/origin/112/2019/08/30/3206489.jpg"/>
<meta property="og:description" content="메타디스크립션OG"/>
<meta property="og:article:author" content="메타값OG"/>
...
<body>
  ...
  <footer class="page-footer text-center font-small mt-4 wow fadeIn">
    ...
    <div class="pt-4">
      ...
      <a class="btn btn-outline-white" href="http://localhost/ideaRecommend/MVC/main/selectIdea/shareIdea/mvc/shareIdea_View/shareIdae_View.php?id=<?=$_GET['id']?>" data-rel="dialog">공유하기
        <i class="fas fa-graduation-cap ml-2"></i>
      </a>
    </div>
    <!--/.Call to action-->
